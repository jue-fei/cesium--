...
event_configs = {
    ...
    "BLAST-2026-002": {
        "section": {"W": 15.56, "Hw": 2.45, "R": 7.78, "totalH": 10.23, "shape": "horseshoe"},
        "cut_pattern": "wedge",
        "cut_r": 2.0,
        "aux_rings": [{"r": 3.6, "n": 8}, {"r": 6.0, "n": 10}, {"r": 8.3, "n": 12}, {"r": 10.2, "n": 14}],
        "perim_spacing": 0.45,
        "hole_depth": 3.0,
        "diameter": 0.04,
        ...
        "delay_step_ms": 100,
        "explosive_type": "emulsion",
        "desc": "南山隧道全断面楔形掏槽微差爆破（V=113.64(Q^1/3/R)^1.341）",
    },
    "BLAST-2026-003": {
...
events_meta = [
    ...
    ("BLAST-2026-002", "南山隧道上台阶楔形掏槽微差爆破", 116.3915, 39.9015, 0, 170, "emulsion", "nonel",
     datetime(2026, 7, 16, 14, 0), "limestone", "cloudy", 18, 5, 90, "planned", "南山上台阶楔形掏槽，微差降振，V=113.64(Q^1/3/R)^1.341"),
...
kco_params = {
    ...
    "BLAST-2026-002": {
        "x50": 0.22, "xmax": 1.2, "b": 2.2, "n": 1.1, "fragment_count": 180,
        "crater_center_offset_y": 0.38,
        "smoke": 0.3, "dust": 0.2, "fire": 0.8, "spark": 0.6, "shockwave": 5.0,
    },
    "BLAST-2026-003": {
...
blast_effect = {
    ...
    "BLAST-2026-002": {
        "crater_depth": 2.5, "crater_radius": 4.0,
        "overbreak": 0.10, "underbreak": 0.06, "half_hole_ratio": 0.75,
        "max_throw": 14.0, "avg_throw": 9.0, "throw_concentration": 0.70,
        "max_vibration": 4.8, "max_air_overpressure": 118, "min_safety_distance": 220,
        "frag_x50": 0.22, "frag_xmax": 1.2,
        "desc": "南山隧道全断面楔形掏槽微差爆破-降振效果良好",
    },
    "BLAST-2026-003": {
