...
import { BlastingManager } from '@/features/blasting/blastingManager.js'
import {
  buildExampleBlastingDataset,
  normalizeBlastingDataset
} from '@/features/blasting/core/io/blastingDataCore.js'
...
export default function useBlasting() {
  ...
  const startPlayback = () => {
    ...
    playbackTimer = setInterval(
      ...
      Math.max(16, Number(playbackSpeedMs.value || 120))
    )
  }
