...
export const STRESS_TURBO_RAMP_32 = Object.freeze([
  { value: 0.0, color: '#123b7a', label: '零应力基底' },
  ...
  { value: 0.3871, color: '#5fceb8', label: '中等偏上' },
  ...
  { value: 0.6129, color: '#c5c044', label: '' },
  ...
  { value: 1.0, color: '#98181a', label: '已损毁区' }
])
