...
:deep(.param-collapse .el-collapse-item__header) {
  background: transparent !important;
  border: none !important;
  padding: 0 !important;
  height: auto !important;
}
:deep(.param-collapse .el-collapse-item__wrap) {
  background: transparent !important;
  border: none !important;
}
:deep(.param-collapse .el-collapse-item__content) {
  padding: 0 !important;
...
:deep(.field-slider .el-slider__runway) {
  margin: 4px 0 !important;
  height: 3px !important;
}
:deep(.field-slider .el-slider__bar) {
  background: #409eff !important;
  height: 3px !important;
}
:deep(.field-slider .el-slider__button) {
...
.action-btn.primary {
  flex: 1;
  background: linear-gradient(135deg, #409eff, #3370c4);
  border-color: #409eff;
  color: #fff;
}
.action-btn.primary:hover:not(:disabled) {
  background: linear-gradient(135deg, #5aafff, #4080d4);
